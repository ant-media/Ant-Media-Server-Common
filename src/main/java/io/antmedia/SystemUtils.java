...
public final class SystemUtils {
    ...
    public static long osCommittedVirtualMemory() {
        try {
			...
			return (Long)(osBean.getCommittedVirtualMemorySize());
        } catch (Exception e) {
            error(e);
            return -1L;
        }
    ...
    public static long osTotalPhysicalMemory() {
        try {
			com.sun.management.OperatingSystemMXBean osBean = ManagementFactory
					.getPlatformMXBean(com.sun.management.OperatingSystemMXBean.class);
			return (Long)(osBean.getTotalPhysicalMemorySize());
        } catch (Exception e) {
            error(e);
            return -1L;
        }
    ...
    public static long osFreePhysicalMemory() {
        try {
			com.sun.management.OperatingSystemMXBean osBean = ManagementFactory
					.getPlatformMXBean(com.sun.management.OperatingSystemMXBean.class);
			return (Long)(osBean.getFreePhysicalMemorySize());
        } catch (Exception e) {
            error(e);
            return -1L;
        }
    ...
    public static long osTotalSwapSpace() {
        try {
			com.sun.management.OperatingSystemMXBean osBean = ManagementFactory
					.getPlatformMXBean(com.sun.management.OperatingSystemMXBean.class);
			return (Long)(osBean.getTotalSwapSpaceSize());
        } catch (Exception e) {
            error(e);
            return -1L;
        }
    ...
    public static long osFreeSwapSpace() {
        ...
        try {
			com.sun.management.OperatingSystemMXBean osBean = ManagementFactory
					.getPlatformMXBean(com.sun.management.OperatingSystemMXBean.class);
			return (Long)(osBean.getFreeSwapSpaceSize());
        } catch (Exception e) {
            error(e);
            return -1L;
        }
    ...
    public static Long getProcessCpuTime() {
        try {
            com.sun.management.OperatingSystemMXBean osBean = ManagementFactory
                    .getPlatformMXBean(com.sun.management.OperatingSystemMXBean.class);
            return (Long) (osBean.getProcessCpuTime() / 1000);
        } catch (Exception e) {
            error(e);
            return -1l;
        }
