...
public class AppSettings {
	...
	public static final String SETTINGS_ENABLE_HLS_ENCRYPTION = "settings.enableHlsEncryption";
	public static final String SETTINGS_HLS_ENCRYPTION_KEY = "settings.HlsEncryptionKey";
	public static final String SETTINGS_HLS_ENCRYPTION_KEY_URL = "settings.HlsEncryptionKeyUrl";
	public static final String SETTINGS_HLS_ENCRYPTION_IV = "settings.HlsEncryptionIv";
	...
	*/
	...
	//bbbb
	/**
	 * Enable/disable HLS AES128 encryption
	 *  When enabled every HLS segment generated is encrypted and the encryption key
	 *  Default value is false
	 */
	@Value( "${"+SETTINGS_ENABLE_HLS_ENCRYPTION+":false}" )
	private boolean hlsEncryptionEnabled;
	
	/**
	 * HLS Encryption key with 16-octet to encrypt the segments
	 *  Default value is null.
	 *  If you enable HLS Encryption with null {hlsEncryptionKey} , It will generating randomly.
	 */
	@Value( "${" + SETTINGS_HLS_ENCRYPTION_KEY +":#{null}}")
	private String hlsEncryptionKey;
	
	/**
	 * If you have custom AES-128 key URL, it will use entered HLS encryption key
	 *  Default value is null.
	 */
	@Value( "${" + SETTINGS_HLS_ENCRYPTION_KEY_URL +":#{null}}")
	private String hlsEncryptionKeyUrl;
	
	/**
	 * HLS Encryption key with 16-octet initialization vector for every segment instead of the autogenerated ones
	 *  Default value is null.
	 *  If you enable HLS Encryption with null {hlsEncryptionIv} , It will generating randomly.
	 */
	@Value( "${" + SETTINGS_HLS_ENCRYPTION_IV +":#{null}}")
	...
	public boolean isHlsEncryptionEnabled() {
		return hlsEncryptionEnabled;
	}

	public void setHlsEncryptionEnabled(boolean hlsEncryptionEnabled) {
		this.hlsEncryptionEnabled = hlsEncryptionEnabled;
	}

	public String getHlsEncryptionKey() {
		return hlsEncryptionKey;
	}

	public void setHlsEncryptionKey(String hlsEncryptionKey) {
		this.hlsEncryptionKey = hlsEncryptionKey;
	}

	public String getHlsEncryptionKeyUrl() {
		return hlsEncryptionKeyUrl;
	}

	public void setHlsEncryptionKeyUrl(String hlsEncryptionKeyUrl) {
		this.hlsEncryptionKeyUrl = hlsEncryptionKeyUrl;
	}

	public String getHlsEncryptionIv() {
		return hlsEncryptionIv;
	}

	public void setHlsEncryptionIv(String hlsEncryptionIv) {
